...
// node_modules/@telegram-apps/init-data-node/dist/entries/shared-BvCEfSRU.js
...
var d$1 = class d extends Error {
  constructor(e2, t3, n2) {
    super(
      typeof t3 == "object" ? t3.message : t3 || e2,
      {
        cause: typeof t3 == "object" ? t3.cause : n2
      }
    ), this.type = e2, this.name = "TypedError", Object.setPrototypeOf(this, d.prototype);
  }
};
var ERR_AUTH_DATE_INVALID = "ERR_AUTH_DATE_INVALID";
var ERR_HASH_INVALID = "ERR_HASH_INVALID";
var ERR_EXPIRED = "ERR_EXPIRED";
var ERR_SIGN_INVALID = "ERR_SIGN_INVALID";
...
var u = class _u extends Error {
  constructor(e2, r3, n2) {
    super(
      typeof r3 == "object" ? r3.message : r3 || e2,
      {
        cause: typeof r3 == "object" ? r3.cause : n2
      }
    ), this.type = e2, this.name = "TypedError", Object.setPrototypeOf(this, _u.prototype);
  }
};
var W = "ERR_UNEXPECTED_TYPE";
var d2 = "ERR_PARSE";
function i(t3, e2) {
  return (r3) => {
    const n2 = (o3) => {
      if (!(r3 && o3 === void 0))
        try {
          ...
          throw new u(d2, {
            message: `"${t3}" transformer failed to parse the value`,
            cause: a
          });
        }
    };
...
function p(t3) {
  throw new u(W, `Unexpected value received: ${JSON.stringify(t3)}`);
}
var E = i("boolean", (t3) => {
...
var U = i("date", (t3) => t3 instanceof Date ? t3 : new Date(g()(t3) * 1e3));
...
var t = ({ base: e2 = "", routes: t3 = [], ...r3 } = {}) => ({ __proto__: new Proxy({}, { get: (r4, o3, a, s2) => (r5, ...c2) => t3.push([o3.toUpperCase?.(), RegExp(`^${(s2 = (e2 + r5).replace(/\/+(\/|$)/g, "$1")).replace(/(\/?\.?):(\w+)\+/g, "($1(?<$2>*))").replace(/(\/?\.?):(\w+)/g, "($1(?<$2>[^$1/]+?))").replace(/\./g, "\\.").replace(/(\/?)\*/g, "($1.*)?")}/*$`), c2, s2]) && a }), routes: t3, ...r3, async fetch(e3, ...o3) {
  let a, s2, c2 = new URL(e3.url), n2 = e3.query = { __proto__: null };
  for (let [e4, t4] of c2.searchParams) n2[e4] = n2[e4] ? [].concat(n2[e4], t4) : t4;
  e: try {
    for (let t4 of r3.before || []) if (null != (a = await t4(e3.proxy ?? e3, ...o3))) break e;
    t: for (let [r4, n3, l2, i2] of t3) if ((r4 == e3.method || "ALL" == r4) && (s2 = c2.pathname.match(n3))) {
      e3.params = s2.groups || {}, e3.route = i2;
      for (let t4 of l2) if (null != (a = await t4(e3.proxy ?? e3, ...o3))) break t;
    }
  } catch (t4) {
    if (!r3.catch) throw t4;
    a = await r3.catch(t4, e3.proxy ?? e3, ...o3);
  }
  try {
    for (let t4 of r3.finally || []) a = await t4(a, e3.proxy ?? e3, ...o3) ?? a;
  } catch (t4) {
    if (!r3.catch) throw t4;
    a = await r3.catch(t4, e3.proxy ?? e3, ...o3);
  }
...
var r = (e2 = "text/plain; charset=utf-8", t3) => (r3, o3 = {}) => {
  ...
  const a = new Response(t3?.(r3) ?? r3, o3.url ? void 0 : o3);
...
function t2(e2, n2, r3) {
  ...
  const o3 = Math.ceil((n2 + r3) / 2), s2 = t2(e2, n2, o3), l2 = t2(e2, o3, r3);
...
function o2(e2, t3 = "", r3 = {}) {
  const o3 = "string" != typeof t3 ? t3 : r3, l2 = "string" == typeof t3 ? t3 : "", c2 = e2.map(s), f3 = !!o3.lineNumbers;
  return function(e3, t4 = 0) {
    ...
    e: for (; o4 < e3.length; ) {
      ...
      for (const t5 of c2) {
        ...
        const c3 = t5.regex.exec(e3);
        if (c3 && c3[0].length > 0) {
          if (!t5.discard) {
            const e4 = r4(o4), n3 = "string" == typeof t5.replace ? c3[0].replace(new RegExp(t5.regex.source, t5.regex.flags), t5.replace) : c3[0];
            s2.push({ state: l2, name: t5.name, text: n3, offset: o4, len: c3[0].length, line: e4.line, column: e4.column });
          }
...
function map(p3, mapper) {
  return (data, i2) => mapInner(p3(data, i2), (v, j) => mapper(v, data, i2, j));
}
...
function reduceLeft(acc, p3, reducer) {
  return chainReduce(acc, (acc2) => map(p3, (v, data, i2, j) => reducer(acc2, v, data, i2, j)));
}
function leftAssoc2(pLeft, pOper, pRight) {
  return chain(pLeft, (v0) => reduceLeft(v0, ab(pOper, pRight, (f3, y) => [f3, y]), (acc, [f3, y]) => f3(acc, y)));
}
function chain(p3, f3) {
  return (data, i2) => mapOuter(p3(data, i2), (m1) => f3(m1.value, data, i2, m1.position)(data, m1.position));
}
...
function _serIdent(str) {
  return str.replace(
    ...
    (m, d1, d22, hy, safe, nl2, ctrl, other) => d1 ? _codePoint(d1) : d22 ? "-" + _codePoint(d22.slice(1)) : hy ? "\\-" : safe ? safe : nl2 ? "\uFFFD" : ctrl ? _codePoint(ctrl) : "\\" + other
  );
}
...
for (i2 = 0; i2 < base64Chars.length; i2++) {
    ...
    for (const key of ["delivered-to", "return-path"]) {
      ...
      if (addressHeader && addressHeader.value) {
        ...
        if (addresses && addresses.length && addresses[0].address) {
          const camelKey = key.replace(/\-(.)/g, (o3, c2) => c2.toUpperCase());
